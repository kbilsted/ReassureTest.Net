...
namespace ReassureTest.Tests
{
    public class NestedTests
    {
        ...
        public void When_filtering_only_on_string_fields_Then_only_get_s2()
        {
            ...
            cfg.Harvesting.Add((parent, field, pi) => parent == null || pi.PropertyType == typeof(string) ? Flow.Use(field) : Flow.Skip);
        ...
        {
            var cfg = Reassure.DefaultConfiguration.DeepClone();
            cfg.Harvesting.Add((parent, field, pi) => parent == null || pi.Name.StartsWith("S") ? Flow.Use(field) : Flow.Skip);
        ...
        {
            var cfg = Reassure.DefaultConfiguration.DeepClone();
            cfg.Harvesting.Add((parent, field, pi) => parent == null || field is string s && s == "hello" ? Flow.Use(field) : Flow.Skip);
